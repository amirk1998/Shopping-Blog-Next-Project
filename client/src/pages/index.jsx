...
export default function Home() {
  ...
  return (
    <div className='App grid min-h-screen gap-4 bg-gray-100 md:grid-cols-12 md:grid-rows-[60px_minmax(300px,_1fr)] '>
      <div className='hidden md:col-span-3 md:row-span-2 md:block'>
        <div className='overflow-hidden rounded-3xl bg-white'>
          ...
          <div className={`${isOpen ? 'block' : 'hidden'}`}>
            ...
            <Link href='#'>
              <a className='mb-1 block py-2 pr-4 hover:bg-indigo-100'> ریکت</a>
            </Link>
            <Link href='#'>
