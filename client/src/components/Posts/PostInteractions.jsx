...
const PostInteractions = ({ post, isSmall, className }) => {
  ...
  return (
    ...
    >
      ...
      <button className='flex items-center gap-x-1 rounded-md bg-red-200 px-1 py-0.5 text-red-500 hover:bg-red-500 hover:text-red-100'>
        {post.isLiked ? (
      ...
      <button className='flex items-center gap-x-1 rounded-md bg-blue-200 px-1 py-0.5 text-blue-500 hover:bg-blue-500 hover:text-blue-200'>
        {post.isBookmarked ? (
